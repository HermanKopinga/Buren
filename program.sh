...
"/Applications/Arduino 1.6.4.app/Contents/Java/hardware/tools/avr/bin/avrdude" -C"/Applications/Arduino 1.6.4.app/Contents/Java/hardware/tools/avr/etc/avrdude.conf" -v -patmega328p -cusbtiny -Uflash:w:/Users/hermankopinga/Dropbox/Geek/Arduino/hardware/werc/bootloaders/optiboot/optiboot_atmega328_96_1.hex:i -Ulock:w:0x0F:m && \
